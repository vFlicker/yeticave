...
VALUES (
        ...
        5400,
        20,
        '2023-06-26T17:17:03.305Z'
    );

INSERT INTO
    bets (user_id, lot_id, price)
VALUES (1, 1, 11500), (3, 6, 6000), (2, 5, 8000), (3, 5, 8400);

ALTER TABLE lots
ADD
    COLUMN ts tsvector GENERATED ALWAYS AS (to_tsvector('english', title)) STORED;
