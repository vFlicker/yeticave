...
// Также проверять формат загруженного файла в поле «Аватар», это обязательно должно быть изображение. Для проверки сравнивать MIME-тип файла со списком разрешенных. Чтобы определить MIME-тим файла использовать функцию mime** _ content _ **type
